"""
Thermal Probe Peak Picker Application - Enhanced Version with Logging and Peak-Trough Algorithm
==============================================================================================
...
- Interactive manual peak selection and editing with enhanced removal capabilities
- Visual error markers showing exact error locations on graph
- Time range exclusion capabilities
- Comprehensive error checking for peak quality
- Parameter persistence via .par configuration files
- Auto-load CSV files specified in .par files
- Customizable output filenames and folders
- Enhanced logging system for session tracking
- Peak-trough amplitude calculation algorithm
- Improved UI layout with data display prioritized
- Enhanced robustness and error handling

New in this version:
- Comprehensive logging system with session tracking
- Peak-trough amplitude calculation method for better accuracy
- Enhanced terminal output with user-friendly information
- Log file management and session history
