...
================================================================================
Thermal Probe Peak Picker (tts_peakpick.py)
================================================================================
...
1. SAVE AND RUN
   - Save `tts_peakpick
.py` to a directory of your choice
...
================================================================================
PARAMETER FILE CONFIGURATION (tts_peakpick.par)
================================================================================

The parameter file allows you to save and load application settings. Create a
file named `tts_peakpick.par` in the same folder as `tts_peakpick.py`.
