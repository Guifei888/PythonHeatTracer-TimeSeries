#!/usr/bin/env python3
"""
TTS_MERGPARS.py - Temperature Time Series Merger and Processor
...
- Input parameter file: tts_mergpars.par
- Two CSV files with temperature data

Usage:
    python tts_mergpars.py
    
The script looks for tts_mergpars.par in the current directory or script directory.
"""
